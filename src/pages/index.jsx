        ...
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            ...
            <span className="block text-zinc-600 dark:text-zinc-400 xl:inline">
              I build things for the web and talk about tech.
            </span>
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I love building software, meeting cool people, and talking about all things tech. I&apos;m currently working as Lead Software Developer at Prime Home Solutions, and a fourth-year computer science student at Boise State University.
          </p>
