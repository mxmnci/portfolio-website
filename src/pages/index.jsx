...
function Resume() {
  let resume = [
    ...
    },
    {
      ...
      logo: logoCentralValleyEngineeringAndAsphalt,
      start: '2020',
      end: '2021',
    },
  ]
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>Max Monciardini</title>
        <meta
          name="description"
          content="I love building software, meeting cool people, and talking about the
          latest innovations in tech. I'm currently working as Full Stack Developer at Colosseum"
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I love building software, meeting cool people, and talking about the
            latest innovations in tech. I&apos;m currently working as Full Stack
            Developer at{' '}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-6 flex gap-6">
            ...
            />
            <SocialLink
              href="https://www.linkedin.com/in/mxmnci/"
